export const songs = [
	...
	},
	{
		title: 'King Kunta',
		artist: 'Kendrick Lamar',
		txt: `Bitch where you when I was walkin? Now I run the game got the whole world talkin (King Kunta). Everybody wanna cut the legs off him (King Kunta). Black man taking no losses. Bitch where you when I was walkin? Now I run the game, got the whole world talkin (King Kunta). Everybody wanna cut the legs off him.`,
	},
	{
