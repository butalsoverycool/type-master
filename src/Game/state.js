...
// pick rand material
const pickMaterial = (library, propKey) => {
	...
	return typeof library[rand] === 'string'
		? library[rand]
		: typeof library[rand][propKey] === 'string'
		? library[rand][propKey]
		: () => {
				console.log('Material input not correct');
				return null;
		  };
};
...
export const initialState = {
	boardMode: 'default',
	material: pickMaterial(songs, 'lyrics'),
	gameOn: false,
	input: ' ',
	typeCount: 0,
	p: 0,
